...
export default async function CompanyContactInfoPage() {
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6">
            {/* Header */}
            <div>
              <h1 className="text-3xl font-bold">Company Contact Info</h1>
              <p className="text-muted-foreground mt-2">
                Manage contact information for the company website
              </p>
            </div>
